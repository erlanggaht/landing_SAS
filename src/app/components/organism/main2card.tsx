...
export default function Main2Card() {
  return (
    <>
     <section className="flex  justify-center flex-col md:flex-row gap-3">
          <div className={"card1 w-full  relative before:bg-cover before:w-full before:h-full before:absolute before:bg-card1 before:grayscale before:hover:grayscale-0 cursor-text"}>
          ...
          <div className="card2 w-full bg-cover relative before:bg-cover before:w-full before:h-full before:absolute before:bg-card2 before:grayscale before:hover:grayscale-0 cursor-text">
            <div className="areadesc p-8">
