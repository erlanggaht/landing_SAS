    ...
    <>
     <div data-element="fields" data-stacked="false" className="flex items-center w-full max-w-md mb-3 seva-fields formkit-fields ">
                        ...
                        <button data-element="submit" className="formkit-submit">
                            ...
                            <span className="px-5 py-3 text-sm font-medium text-center text-white bg-yellowBase rounded-lg cursor-pointer hover:opacity-90 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Subscribe</span>
                        </button>
                    </div>
    </>
     )
